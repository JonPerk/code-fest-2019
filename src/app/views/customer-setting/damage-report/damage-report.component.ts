...
export class DamageReportComponent implements OnInit {
  ...
  public lineChart2Data: Array<any> = [
    {
      data: [1, 18, 9, 17, 34, 22, 11, 27, 17, 20],
      label: 'Cases'
    }
  ];
  public lineChart2Labels: Array<any> = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September',
      'October'];
